            ...
            <section class="table-card" aria-label="Participants table">
                <div class="table-toolbar">
                    <h2 class="toolbar-title">
                        <svg viewBox="0 0 24 24"><circle cx="9" cy="8" r="3"></circle><path d="M2.5 19c1.1-2.7 3.4-4 6.5-4"></path><circle cx="17" cy="9" r="2.5"></circle><path d="M14.5 18.5c.8-1.8 2.2-2.8 4.2-2.8"></path></svg>
                        All Registrations
                    </h2>
