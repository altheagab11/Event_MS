...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stat-card.peach { background: #f1d7b2; }
        .stat-card.gold { background: var(--gold); }
        .stat-card.blue { background: #5d7d9a; color: #fff; }
        ...
        @media (max-width: 1300px) {
            ...
            .demographic-head { font-size: 16px; }
        ...
        <main class="content">
            <div class="topbar">
                ...
                <button class="scan-btn" type="button">
                    <svg viewBox="0 0 24 24"><path d="M4 8V5a1 1 0 0 1 1-1h3"></path><path d="M20 8V5a1 1 0 0 0-1-1h-3"></path><path d="M4 16v3a1 1 0 0 0 1 1h3"></path><path d="M20 16v3a1 1 0 0 1-1 1h-3"></path><circle cx="12" cy="12" r="2.5"></circle></svg>
                    OPEN QR SCANNER
                </button>
            </div>
            ...
            <section class="stats">
                <article class="card stat-card peach">
                    ...
                    <div class="icon-box">
                        <svg viewBox="0 0 24 24"><circle cx="8" cy="8" r="3"></circle><circle cx="16" cy="9" r="2.5"></circle><path d="M3 20c1-3 3.5-4.5 6-4.5S14 17 15 20"></path><path d="M13 20c.6-2 2.3-3 4-3 1.6 0 3.1.9 4 3"></path></svg>
                    </div>
                </article>
                ...
                <article class="card stat-card gold">
                    ...
                    <div class="icon-box">
                        <svg viewBox="0 0 24 24"><path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z"></path><polyline points="14 3 14 8 19 8"></polyline><line x1="9" y1="13" x2="15" y2="13"></line><line x1="9" y1="17" x2="13" y2="17"></line></svg>
                    </div>
                </article>
                ...
                <article class="card stat-card white">
                    ...
                    <div class="icon-box">
                        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"></circle><path d="M8 12l2.5 2.5L16 9"></path></svg>
                    </div>
                </article>
            </section>
                ...
                <article class="card">
                    ...
                    <div class="demographic">
                        ...
                        <div class="demographic-row">
                            ...
                            <div class="track"><div class="fill gold" style="width: 20%"></div></div>
                        </div>
                        <div class="demographic-row">
                            <div class="demographic-head"><span>Graduate</span><span>10%</span></div>
                            <div class="track"><div class="fill gray" style="width: 10%"></div></div>
                        </div>
                        <div class="demographic-row">
                            <div class="demographic-head"><span>Professional/Faculty</span><span>5%</span></div>
                            <div class="track"><div class="fill" style="width: 5%; background:#e8eef8"></div></div>
                        </div>
                    </div>
                </article>
